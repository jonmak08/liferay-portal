				...
				<div class="footer-content">
					<ul>
						<a href="https://facebook.com/nyxl">
							<li>
								<svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="-204.5 1 216 216" xml:space="preserve">
				...
				<div class="footer-content">
					<ul>
						<a href="https://instagram.com/nyxl">
							<li>
								<svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="100%" height="100%">
				...
				<div class="footer-content">
					<ul>
						<a href="https://twitter.com/nyxl">
							<li>
								<svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="-196.5 1 216 216" xml:space="preserve">
				...
				<div class="footer-content">
					<ul>
						<a href="https://youtube.com/c/nyxl">
							<li>
								<svg aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 64 64" width="100%" height="100%">
