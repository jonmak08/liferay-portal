...
<<<<<<< HEAD
	...
	*/
	public static List<KaleoTimerInstanceToken> findByKITI_B_C(
		...
		return getPersistence()
				   .findByKITI_B_C(kaleoInstanceTokenId, blocking, completed);
	}
...
<<<<<<< HEAD
	public static KaleoTimerInstanceToken findByKITI_B_C_First(
		...
		throws com.liferay.portal.workflow.kaleo.exception.NoSuchTimerInstanceTokenException {
		return getPersistence()
				   .findByKITI_B_C_First(kaleoInstanceTokenId, blocking,
	...
	*/
	public static KaleoTimerInstanceToken fetchByKITI_B_C_First(
		...
		OrderByComparator<KaleoTimerInstanceToken> orderByComparator) {
		return getPersistence()
				   .fetchByKITI_B_C_First(kaleoInstanceTokenId, blocking,
			completed, orderByComparator);
	}
...
<<<<<<< HEAD
	public static KaleoTimerInstanceToken findByKITI_B_C_Last(
		...
		throws com.liferay.portal.workflow.kaleo.exception.NoSuchTimerInstanceTokenException {
		return getPersistence()
				   .findByKITI_B_C_Last(kaleoInstanceTokenId, blocking,
			completed, orderByComparator);
	}
	...
	*/
	public static KaleoTimerInstanceToken fetchByKITI_B_C_Last(
		...
		OrderByComparator<KaleoTimerInstanceToken> orderByComparator) {
		return getPersistence()
				   .fetchByKITI_B_C_Last(kaleoInstanceTokenId, blocking,
			completed, orderByComparator);
	}
...
<<<<<<< HEAD
	public static KaleoTimerInstanceToken[] findByKITI_B_C_PrevAndNext(
		...
		throws com.liferay.portal.workflow.kaleo.exception.NoSuchTimerInstanceTokenException {
		return getPersistence()
				   .findByKITI_B_C_PrevAndNext(kaleoTimerInstanceTokenId,
	...
	* @param completed the completed
	*/
	public static void removeByKITI_B_C(long kaleoInstanceTokenId,
		boolean blocking, boolean completed) {
		getPersistence()
			.removeByKITI_B_C(kaleoInstanceTokenId, blocking, completed);
	}
	...
	* @return the number of matching kaleo timer instance tokens
	*/
	public static int countByKITI_B_C(long kaleoInstanceTokenId,
		boolean blocking, boolean completed) {
		return getPersistence()
				   .countByKITI_B_C(kaleoInstanceTokenId, blocking, completed);
=======
