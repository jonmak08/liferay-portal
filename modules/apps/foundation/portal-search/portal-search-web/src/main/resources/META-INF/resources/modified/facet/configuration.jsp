	...
	<div class="portlet-configuration-body-content">
		<div class="container-fluid-1280">
			<aui:fieldset id='<%= renderResponse.getNamespace() + "MODIFIEDrangesId" %>'>
				...
				<aui:input name="<%= PortletPreferencesJspUtil.getInputName(ModifiedFacetPortletPreferences.PREFERENCE_KEY_RANGES) %>" type="hidden" value="<%= modifiedFacetPortletPreferences.getRanges() %>" />
