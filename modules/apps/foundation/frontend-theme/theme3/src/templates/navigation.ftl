			...
			<#list nav_items as nav_item>
				...
				<#if !nav_item.hasChildren()>
					...
					<#elseif nav_item.hasChildren()>
						<li class="child-menu" role="menu">
							<a aria-labelledby="layout_${nav_item.getLayoutId()}" ${nav_item_attr_has_popup} href="${nav_item.getURL()}" ${nav_item.getTarget()} class="dropdown-toggle" data-toggle="dropdown" role="menuitem">
