                    ...
                    <span class="posted-on">
                        <a href="${templatesPath}" rel="bookmark">
                            <time class="entry-date" datetime="">
                                <#assign Datefyr2_Data = getterUtil.getString(Datefyr2.getData())>
                                <#if validator.isNotNull(Datefyr2_Data)>
                                    <#assign Datefyr2_DateObj = dateUtil.parseDate("yyyy-MM-dd", Datefyr2_Data, locale)>
                                    ${dateUtil.getDate(Datefyr2_DateObj, "dd MMM yyyy", locale)}
                                </#if>
                            </time>
                        </a>
                    </span>
