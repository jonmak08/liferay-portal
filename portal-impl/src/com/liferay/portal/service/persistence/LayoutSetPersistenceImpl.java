...
public class LayoutSetPersistenceImpl extends BasePersistenceImpl<LayoutSet>
	...
	protected void cacheUniqueFindersCache(LayoutSet layoutSet) {
		if (layoutSet.isNew()) {
			...
			args = new Object[] {
					layoutSet.getPrivateLayout(), layoutSet.getLogoId()
				};

			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_P_L, args,
				Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_P_L, args, layoutSet);
		}
		else {
	...
	protected void clearUniqueFindersCache(LayoutSet layoutSet) {
		...
		args = new Object[] { layoutSet.getPrivateLayout(), layoutSet.getLogoId() };
