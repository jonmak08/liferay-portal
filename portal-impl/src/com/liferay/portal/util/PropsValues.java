...
public class PropsValues {
	...
	public static final int COMPANY_SECURITY_AUTO_LOGIN_MAX_AGE = GetterUtil.getInteger(PropsUtil.get(PropsKeys.COMPANY_SECURITY_AUTO_LOGIN_MAX_AGE), CookieKeys.MAX_AGE_IN_SECONDS);
	...
	public static boolean INDEX_PORTAL_FIELD_ANALYZER_ENABLED = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.INDEX_PORTAL_FIELD_ANALYZER_ENABLED));
	...
	public static final boolean INDEX_SEARCH_LEADING_WILDCARD_ENABLED = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.INDEX_SEARCH_LEADING_WILDCARD_ENABLED));
