// $ANTLR 3.0.1 Creole10.g 2016-08-08 12:28:42
...
public class Creole10Parser extends Parser {
        ...
        try {
            ...
            do {
            	...
            	case 2 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_table_cell_in_table_row2363);
            	    tc=table_cell();
            	    _fsp--;
            	    if (failed) return row;
            	    if ( backtracking==0 ) {
            ...
            pushFollow(FOLLOW_table_rowseparator_in_table_row2372);
            table_rowseparator();
            _fsp--;
            if (failed) return row;
        ...
        try {
            ...
            switch (alt88) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_table_headercell_in_table_cell2393);
                    th=table_headercell();
                    _fsp--;
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_table_normalcell_in_table_cell2404);
                    tc=table_normalcell();
                    _fsp--;
                    if (failed) return cell;
                    if ( backtracking==0 ) {
    ...
    public final TableHeaderNode table_headercell() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_table_headercell_markup_in_table_headercell2420);
            table_headercell_markup();
            _fsp--;
            if (failed) return header;
            pushFollow(FOLLOW_table_cellcontent_in_table_headercell2427);
    ...
    public final TableDataNode table_normalcell() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_table_cell_markup_in_table_normalcell2443);
            table_cell_markup();
            _fsp--;
            if (failed) return cell;
            pushFollow(FOLLOW_table_cellcontent_in_table_normalcell2450);
            tc=table_cellcontent();
            _fsp--;
            if (failed) return cell;
            if ( backtracking==0 ) {
    ...
    public final CollectionNode table_cellcontent() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_onestar_in_table_cellcontent2466);
            onestar();
            _fsp--;
            if (failed) return items;
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_table_cellcontentpart_in_table_cellcontent2475);
            	    ...
            	    pushFollow(FOLLOW_onestar_in_table_cellcontent2482);
            	    onestar();
            	    _fsp--;
            	    if (failed) return items;
        ...
        try {
            ...
            switch (alt90) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_table_formattedelement_in_table_cellcontentpart2503);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_table_unformattedelement_in_table_cellcontentpart2514);
        ...
        try {
            ...
            switch (alt95) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_ital_markup_in_table_formattedelement2530);
                    ital_markup();
                    _fsp--;
                    if (failed) return content;
                    ...
                    switch (alt91) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_table_italcontent_in_table_formattedelement2540);
                    ...
                    switch (alt92) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_ital_markup_in_table_formattedelement2549);
                            ital_markup();
                            _fsp--;
                            if (failed) return content;
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_bold_markup_in_table_formattedelement2557);
                    bold_markup();
                    _fsp--;
                    if (failed) return content;
                    ...
                    switch (alt93) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_table_boldcontent_in_table_formattedelement2564);
                    ...
                    switch (alt94) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_bold_markup_in_table_formattedelement2574);
                            bold_markup();
                            _fsp--;
                            if (failed) return content;
        ...
        try {
            ...
            switch (alt97) {
                case 1 :
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_table_boldcontentpart_in_table_boldcontent2600);
                    	    ...
                    	    pushFollow(FOLLOW_onestar_in_table_boldcontent2605);
                    	    onestar();
                    	    _fsp--;
                    	    if (failed) return items;
                ...
                case 2 :
                    ...
                    {
                    match(input,EOF,FOLLOW_EOF_in_table_boldcontent2613); if (failed) return items;
        ...
        try {
            ...
            switch (alt99) {
                case 1 :
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_table_italcontentpart_in_table_italcontent2636);
                    	    ...
                    	    pushFollow(FOLLOW_onestar_in_table_italcontent2641);
                    	    onestar();
                    	    _fsp--;
                    	    if (failed) return items;
                ...
                case 2 :
                    ...
                    {
                    match(input,EOF,FOLLOW_EOF_in_table_italcontent2649); if (failed) return items;
        ...
        try {
            ...
            switch (alt101) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_table_formattedcontent_in_table_boldcontentpart2667);
                ...
                case 2 :
                    ...
                    _fsp--;
                    if (failed) return node;
                    pushFollow(FOLLOW_table_bolditalcontent_in_table_boldcontentpart2681);
                    ...
                    switch (alt100) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_ital_markup_in_table_boldcontentpart2688);
                            ital_markup();
                            _fsp--;
                            if (failed) return node;
        ...
        try {
            ...
            switch (alt103) {
                case 1 :
                    ...
                    _fsp--;
                    if (failed) return node;
                    pushFollow(FOLLOW_table_bolditalcontent_in_table_italcontentpart2712);
                    tb=table_bolditalcontent();
                    _fsp--;
                    if (failed) return node;
                    if ( backtracking==0 ) {
                    ...
                    switch (alt102) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_bold_markup_in_table_italcontentpart2719);
                            bold_markup();
                            _fsp--;
                            if (failed) return node;
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_table_formattedcontent_in_table_italcontentpart2731);
                    tf=table_formattedcontent();
                    _fsp--;
                    if (failed) return node;
                    if ( backtracking==0 ) {
        ...
        try {
            ...
            switch (alt105) {
                case 1 :
                    ...
                    switch (alt104) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_table_formattedcontent_in_table_bolditalcontent2756);
                            ...
                            pushFollow(FOLLOW_onestar_in_table_bolditalcontent2761);
                            onestar();
                            _fsp--;
                            if (failed) return elements;
                ...
                case 2 :
                    ...
                    {
                    match(input,EOF,FOLLOW_EOF_in_table_bolditalcontent2769); if (failed) return elements;
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_table_unformattedelement_in_table_formattedcontent2789);
            	    tu=table_unformattedelement();
            	    _fsp--;
            	    if (failed) return elements;
            	    if ( backtracking==0 ) {
        ...
        try {
            ...
            switch (alt107) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_table_unformatted_in_table_unformattedelement2812);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_table_inlineelement_in_table_unformattedelement2824);
        ...
        try {
            ...
            switch (alt108) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_link_in_table_inlineelement2844);
                    l=link();
                    _fsp--;
                    if (failed) return element;
                    if ( backtracking==0 ) {
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_image_in_table_inlineelement2854);
                    i=image();
                    _fsp--;
                    if (failed) return element;
                    if ( backtracking==0 ) {
                ...
                case 3 :
                    ...
                    {
                    pushFollow(FOLLOW_extension_in_table_inlineelement2865);
                    e=extension();
                    _fsp--;
                    if (failed) return element;
                    if ( backtracking==0 ) {
                ...
                case 4 :
                    ...
                    {
                    pushFollow(FOLLOW_nowiki_inline_in_table_inlineelement2875);
                    nw=nowiki_inline();
                    _fsp--;
                    if (failed) return element;
                    if ( backtracking==0 ) {
        ...
        try {
            ...
            switch (alt110) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_table_unformatted_text_in_table_unformatted2896);
                ...
                case 2 :
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_forced_linebreak_in_table_unformatted2905);
                    	    forced_linebreak();
                    	    _fsp--;
                    	    if (failed) return text;
                    	    if ( backtracking==0 ) {
                    	...
                    	case 2 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_escaped_in_table_unformatted2917);
                    	    e=escaped();
                    	    _fsp--;
                    	    if (failed) return text;
                    	    if ( backtracking==0 ) {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    if ( (input.LA(1)>=FORCED_END_OF_LINE && input.LA(1)<=WIKI)||input.LA(1)==POUND||input.LA(1)==EQUAL||(input.LA(1)>=NOWIKI_BLOCK_CLOSE && input.LA(1)<=80) ) {
            	        ...
            	        MismatchedSetException mse =
            	            new MismatchedSetException(null,input);
            	        recoverFromMismatchedSet(input,mse,FOLLOW_set_in_table_unformatted_text2943);    throw mse;
            	    }
    ...
    public final NoWikiSectionNode nowiki_block() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_nowikiblock_open_markup_in_nowiki_block3040);
            nowikiblock_open_markup();
            _fsp--;
            if (failed) return nowikiNode;
            pushFollow(FOLLOW_nowiki_block_contents_in_nowiki_block3047);
            ...
            pushFollow(FOLLOW_nowikiblock_close_markup_in_nowiki_block3053);
            nowikiblock_close_markup();
            _fsp--;
            if (failed) return nowikiNode;
            pushFollow(FOLLOW_paragraph_separator_in_nowiki_block3056);
            paragraph_separator();
            _fsp--;
            if (failed) return nowikiNode;
    ...
    public final void nowikiblock_open_markup() throws RecognitionException {
        try {
            ...
            {
            pushFollow(FOLLOW_nowiki_open_markup_in_nowikiblock_open_markup3067);
            nowiki_open_markup();
            _fsp--;
            if (failed) return ;
            pushFollow(FOLLOW_newline_in_nowikiblock_open_markup3070);
            newline();
            _fsp--;
            if (failed) return ;
    ...
    public final void nowikiblock_close_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,NOWIKI_BLOCK_CLOSE,FOLLOW_NOWIKI_BLOCK_CLOSE_in_nowikiblock_close_markup3081); if (failed) return ;
    ...
    public final NoWikiSectionNode nowiki_inline() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_nowiki_open_markup_in_nowiki_inline3096);
            nowiki_open_markup();
            _fsp--;
            if (failed) return nowiki;
            pushFollow(FOLLOW_nowiki_inline_contents_in_nowiki_inline3103);
            t=nowiki_inline_contents();
            _fsp--;
            if (failed) return nowiki;
            pushFollow(FOLLOW_nowiki_close_markup_in_nowiki_inline3107);
            nowiki_close_markup();
            _fsp--;
            if (failed) return nowiki;
            if ( backtracking==0 ) {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    if ( (input.LA(1)>=FORCED_END_OF_LINE && input.LA(1)<=ESCAPE)||(input.LA(1)>=NOWIKI_CLOSE && input.LA(1)<=80) ) {
            	        ...
            	        MismatchedSetException mse =
            	            new MismatchedSetException(null,input);
            	        recoverFromMismatchedSet(input,mse,FOLLOW_set_in_nowiki_block_contents3125);    throw mse;
            	    }
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    if ( (input.LA(1)>=FORCED_END_OF_LINE && input.LA(1)<=WIKI)||(input.LA(1)>=POUND && input.LA(1)<=NOWIKI_BLOCK_CLOSE)||(input.LA(1)>=LINK_CLOSE && input.LA(1)<=80) ) {
            	        ...
            	        MismatchedSetException mse =
            	            new MismatchedSetException(null,input);
            	        recoverFromMismatchedSet(input,mse,FOLLOW_set_in_nowiki_inline_contents3158);    throw mse;
            	    }
    ...
    public final ASTNode horizontalrule() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_horizontalrule_markup_in_horizontalrule3194);
            ...
            switch (alt114) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_blanks_in_horizontalrule3199);
                    blanks();
                    _fsp--;
                    if (failed) return horizontal;
            ...
            pushFollow(FOLLOW_paragraph_separator_in_horizontalrule3205);
            paragraph_separator();
            _fsp--;
            if (failed) return horizontal;
            if ( backtracking==0 ) {
    ...
    public final LinkNode link() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_link_open_markup_in_link3226);
            link_open_markup();
            _fsp--;
            if (failed) return link;
            pushFollow(FOLLOW_link_address_in_link3232);
            a=link_address();
            _fsp--;
            if (failed) return link;
            if ( backtracking==0 ) {
            ...
            switch (alt115) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_link_description_markup_in_link3238);
                    link_description_markup();
                    _fsp--;
                    if (failed) return link;
                    pushFollow(FOLLOW_link_description_in_link3246);
                    d=link_description();
                    _fsp--;
                    if (failed) return link;
                    if ( backtracking==0 ) {
            ...
            pushFollow(FOLLOW_link_close_markup_in_link3254);
            link_close_markup();
            _fsp--;
            if (failed) return link;
        ...
        try {
            ...
            switch (alt116) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_link_interwiki_uri_in_link_address3273);
                    li=link_interwiki_uri();
                    _fsp--;
                    if (failed) return link;
                    match(input,41,FOLLOW_41_in_link_address3276); if (failed) return link;
                    pushFollow(FOLLOW_link_interwiki_pagename_in_link_address3283);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_link_uri_in_link_address3294);
                    lu=link_uri();
                    _fsp--;
                    if (failed) return link;
                    if ( backtracking==0 ) {
        ...
        try {
            ...
            switch (alt117) {
                case 1 :
                    ...
                    {
                    match(input,42,FOLLOW_42_in_link_interwiki_uri3310); if (failed) return interwiki;
                    match(input,43,FOLLOW_43_in_link_interwiki_uri3312); if (failed) return interwiki;
                    if ( backtracking==0 ) {
                ...
                case 2 :
                    ...
                    {
                    match(input,44,FOLLOW_44_in_link_interwiki_uri3319); if (failed) return interwiki;
                    match(input,45,FOLLOW_45_in_link_interwiki_uri3321); if (failed) return interwiki;
                    match(input,46,FOLLOW_46_in_link_interwiki_uri3323); if (failed) return interwiki;
                    match(input,47,FOLLOW_47_in_link_interwiki_uri3325); if (failed) return interwiki;
                    ...
                    match(input,46,FOLLOW_46_in_link_interwiki_uri3331); if (failed) return interwiki;
                    match(input,49,FOLLOW_49_in_link_interwiki_uri3333); if (failed) return interwiki;
                    if ( backtracking==0 ) {
                ...
                case 3 :
                    ...
                    match(input,51,FOLLOW_51_in_link_interwiki_uri3342); if (failed) return interwiki;
                    match(input,49,FOLLOW_49_in_link_interwiki_uri3344); if (failed) return interwiki;
                    match(input,52,FOLLOW_52_in_link_interwiki_uri3346); if (failed) return interwiki;
                    match(input,46,FOLLOW_46_in_link_interwiki_uri3348); if (failed) return interwiki;
                    match(input,53,FOLLOW_53_in_link_interwiki_uri3350); if (failed) return interwiki;
                    if ( backtracking==0 ) {
                ...
                case 4 :
                    ...
                    {
                    match(input,54,FOLLOW_54_in_link_interwiki_uri3358); if (failed) return interwiki;
                    match(input,45,FOLLOW_45_in_link_interwiki_uri3360); if (failed) return interwiki;
                    match(input,45,FOLLOW_45_in_link_interwiki_uri3362); if (failed) return interwiki;
                    match(input,55,FOLLOW_55_in_link_interwiki_uri3364); if (failed) return interwiki;
                    match(input,51,FOLLOW_51_in_link_interwiki_uri3366); if (failed) return interwiki;
                    match(input,56,FOLLOW_56_in_link_interwiki_uri3368); if (failed) return interwiki;
                    if ( backtracking==0 ) {
                ...
                case 5 :
                    ...
                    {
                    match(input,57,FOLLOW_57_in_link_interwiki_uri3375); if (failed) return interwiki;
                    match(input,58,FOLLOW_58_in_link_interwiki_uri3377); if (failed) return interwiki;
                    match(input,59,FOLLOW_59_in_link_interwiki_uri3379); if (failed) return interwiki;
                    ...
                    match(input,46,FOLLOW_46_in_link_interwiki_uri3385); if (failed) return interwiki;
                ...
                case 6 :
                    ...
                    {
                    match(input,60,FOLLOW_60_in_link_interwiki_uri3394); if (failed) return interwiki;
                    match(input,56,FOLLOW_56_in_link_interwiki_uri3396); if (failed) return interwiki;
                    match(input,61,FOLLOW_61_in_link_interwiki_uri3398); if (failed) return interwiki;
                    ...
                    match(input,61,FOLLOW_61_in_link_interwiki_uri3404); if (failed) return interwiki;
                ...
                case 7 :
                    ...
                    {
                    match(input,60,FOLLOW_60_in_link_interwiki_uri3415); if (failed) return interwiki;
                    match(input,56,FOLLOW_56_in_link_interwiki_uri3417); if (failed) return interwiki;
                    match(input,64,FOLLOW_64_in_link_interwiki_uri3419); if (failed) return interwiki;
                    match(input,49,FOLLOW_49_in_link_interwiki_uri3421); if (failed) return interwiki;
                    match(input,61,FOLLOW_61_in_link_interwiki_uri3423); if (failed) return interwiki;
                    ...
                    match(input,46,FOLLOW_46_in_link_interwiki_uri3429); if (failed) return interwiki;
                    match(input,49,FOLLOW_49_in_link_interwiki_uri3431); if (failed) return interwiki;
                    if ( backtracking==0 ) {
                ...
                case 8 :
                    ...
                    {
                    match(input,60,FOLLOW_60_in_link_interwiki_uri3438); if (failed) return interwiki;
                    match(input,45,FOLLOW_45_in_link_interwiki_uri3440); if (failed) return interwiki;
                    match(input,49,FOLLOW_49_in_link_interwiki_uri3442); if (failed) return interwiki;
                    match(input,65,FOLLOW_65_in_link_interwiki_uri3444); if (failed) return interwiki;
                    match(input,60,FOLLOW_60_in_link_interwiki_uri3446); if (failed) return interwiki;
                    match(input,45,FOLLOW_45_in_link_interwiki_uri3448); if (failed) return interwiki;
                    match(input,49,FOLLOW_49_in_link_interwiki_uri3450); if (failed) return interwiki;
                    match(input,65,FOLLOW_65_in_link_interwiki_uri3452); if (failed) return interwiki;
                    if ( backtracking==0 ) {
                ...
                case 9 :
                    ...
                    match(input,64,FOLLOW_64_in_link_interwiki_uri3462); if (failed) return interwiki;
                    match(input,64,FOLLOW_64_in_link_interwiki_uri3464); if (failed) return interwiki;
                    match(input,67,FOLLOW_67_in_link_interwiki_uri3466); if (failed) return interwiki;
                    match(input,47,FOLLOW_47_in_link_interwiki_uri3468); if (failed) return interwiki;
                    match(input,68,FOLLOW_68_in_link_interwiki_uri3470); if (failed) return interwiki;
                    match(input,56,FOLLOW_56_in_link_interwiki_uri3472); if (failed) return interwiki;
                    if ( backtracking==0 ) {
                ...
                case 10 :
                    ...
                    {
                    match(input,66,FOLLOW_66_in_link_interwiki_uri3480); if (failed) return interwiki;
                    match(input,69,FOLLOW_69_in_link_interwiki_uri3482); if (failed) return interwiki;
                    match(input,61,FOLLOW_61_in_link_interwiki_uri3484); if (failed) return interwiki;
                    match(input,65,FOLLOW_65_in_link_interwiki_uri3486); if (failed) return interwiki;
                    match(input,61,FOLLOW_61_in_link_interwiki_uri3488); if (failed) return interwiki;
                    if ( backtracking==0 ) {
                ...
                case 11 :
                    ...
                    {
                    match(input,59,FOLLOW_59_in_link_interwiki_uri3495); if (failed) return interwiki;
                    match(input,67,FOLLOW_67_in_link_interwiki_uri3497); if (failed) return interwiki;
                ...
                case 12 :
                    ...
                    {
                    match(input,59,FOLLOW_59_in_link_interwiki_uri3513); if (failed) return interwiki;
                    match(input,47,FOLLOW_47_in_link_interwiki_uri3515); if (failed) return interwiki;
                    match(input,46,FOLLOW_46_in_link_interwiki_uri3517); if (failed) return interwiki;
                    ...
                    match(input,46,FOLLOW_46_in_link_interwiki_uri3525); if (failed) return interwiki;
                    match(input,49,FOLLOW_49_in_link_interwiki_uri3527); if (failed) return interwiki;
                    if ( backtracking==0 ) {
                ...
                case 13 :
                    ...
                    {
                    match(input,59,FOLLOW_59_in_link_interwiki_uri3535); if (failed) return interwiki;
                    match(input,47,FOLLOW_47_in_link_interwiki_uri3537); if (failed) return interwiki;
                    ...
                    match(input,56,FOLLOW_56_in_link_interwiki_uri3545); if (failed) return interwiki;
                    ...
                    match(input,46,FOLLOW_46_in_link_interwiki_uri3551); if (failed) return interwiki;
                ...
                case 14 :
                    ...
                    {
                    match(input,71,FOLLOW_71_in_link_interwiki_uri3560); if (failed) return interwiki;
                    match(input,61,FOLLOW_61_in_link_interwiki_uri3562); if (failed) return interwiki;
                    match(input,64,FOLLOW_64_in_link_interwiki_uri3564); if (failed) return interwiki;
                    match(input,56,FOLLOW_56_in_link_interwiki_uri3566); if (failed) return interwiki;
                    match(input,45,FOLLOW_45_in_link_interwiki_uri3568); if (failed) return interwiki;
                    match(input,72,FOLLOW_72_in_link_interwiki_uri3570); if (failed) return interwiki;
                    if ( backtracking==0 ) {
                ...
                case 15 :
                    ...
                    {
                    match(input,58,FOLLOW_58_in_link_interwiki_uri3577); if (failed) return interwiki;
                    match(input,65,FOLLOW_65_in_link_interwiki_uri3579); if (failed) return interwiki;
                    match(input,49,FOLLOW_49_in_link_interwiki_uri3581); if (failed) return interwiki;
                    match(input,70,FOLLOW_70_in_link_interwiki_uri3583); if (failed) return interwiki;
                    match(input,58,FOLLOW_58_in_link_interwiki_uri3585); if (failed) return interwiki;
                    match(input,65,FOLLOW_65_in_link_interwiki_uri3587); if (failed) return interwiki;
                    match(input,61,FOLLOW_61_in_link_interwiki_uri3589); if (failed) return interwiki;
                ...
                case 16 :
                    ...
                    match(input,49,FOLLOW_49_in_link_interwiki_uri3600); if (failed) return interwiki;
                    match(input,64,FOLLOW_64_in_link_interwiki_uri3602); if (failed) return interwiki;
                    ...
                    match(input,46,FOLLOW_46_in_link_interwiki_uri3614); if (failed) return interwiki;
                    match(input,49,FOLLOW_49_in_link_interwiki_uri3616); if (failed) return interwiki;
                    if ( backtracking==0 ) {
                ...
                case 17 :
                    ...
                    match(input,46,FOLLOW_46_in_link_interwiki_uri3629); if (failed) return interwiki;
                    match(input,49,FOLLOW_49_in_link_interwiki_uri3631); if (failed) return interwiki;
                    if ( backtracking==0 ) {
                ...
                case 18 :
                    ...
                    {
                    match(input,75,FOLLOW_75_in_link_interwiki_uri3638); if (failed) return interwiki;
                    match(input,68,FOLLOW_68_in_link_interwiki_uri3640); if (failed) return interwiki;
                    match(input,56,FOLLOW_56_in_link_interwiki_uri3642); if (failed) return interwiki;
                    match(input,67,FOLLOW_67_in_link_interwiki_uri3644); if (failed) return interwiki;
                    match(input,45,FOLLOW_45_in_link_interwiki_uri3646); if (failed) return interwiki;
                    match(input,64,FOLLOW_64_in_link_interwiki_uri3648); if (failed) return interwiki;
                    if ( backtracking==0 ) {
                ...
                case 19 :
                    ...
                    match(input,46,FOLLOW_46_in_link_interwiki_uri3659); if (failed) return interwiki;
                    match(input,49,FOLLOW_49_in_link_interwiki_uri3661); if (failed) return interwiki;
                    match(input,70,FOLLOW_70_in_link_interwiki_uri3663); if (failed) return interwiki;
                    match(input,56,FOLLOW_56_in_link_interwiki_uri3665); if (failed) return interwiki;
                    match(input,64,FOLLOW_64_in_link_interwiki_uri3667); if (failed) return interwiki;
                    match(input,49,FOLLOW_49_in_link_interwiki_uri3669); if (failed) return interwiki;
                    match(input,61,FOLLOW_61_in_link_interwiki_uri3671); if (failed) return interwiki;
                    if ( backtracking==0 ) {
                ...
                case 20 :
                    ...
                    {
                    match(input,76,FOLLOW_76_in_link_interwiki_uri3678); if (failed) return interwiki;
                    ...
                    match(input,46,FOLLOW_46_in_link_interwiki_uri3684); if (failed) return interwiki;
                    match(input,49,FOLLOW_49_in_link_interwiki_uri3686); if (failed) return interwiki;
                    if ( backtracking==0 ) {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    if ( (input.LA(1)>=FORCED_END_OF_LINE && input.LA(1)<=WIKI)||(input.LA(1)>=POUND && input.LA(1)<=EQUAL)||(input.LA(1)>=ITAL && input.LA(1)<=NOWIKI_CLOSE)||(input.LA(1)>=IMAGE_CLOSE && input.LA(1)<=80) ) {
            	        ...
            	        MismatchedSetException mse =
            	            new MismatchedSetException(null,input);
            	        recoverFromMismatchedSet(input,mse,FOLLOW_set_in_link_interwiki_pagename3708);    throw mse;
            	    }
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_link_descriptionpart_in_link_description3751);
            	...
            	case 2 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_image_in_link_description3763);
            	    i=image();
            	    _fsp--;
            	    if (failed) return node;
            	    if ( backtracking==0 ) {
        ...
        try {
            ...
            switch (alt123) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_bold_markup_in_link_descriptionpart3788);
                    bold_markup();
                    _fsp--;
                    if (failed) return text;
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_link_bold_descriptionpart_in_link_descriptionpart3799);
                    	    ...
                    	    pushFollow(FOLLOW_onestar_in_link_descriptionpart3804);
                    	    onestar();
                    	    _fsp--;
                    	    if (failed) return text;
                    ...
                    pushFollow(FOLLOW_bold_markup_in_link_descriptionpart3814);
                    bold_markup();
                    _fsp--;
                    if (failed) return text;
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_ital_markup_in_link_descriptionpart3819);
                    ital_markup();
                    _fsp--;
                    if (failed) return text;
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_link_ital_descriptionpart_in_link_descriptionpart3831);
                    ...
                    pushFollow(FOLLOW_ital_markup_in_link_descriptionpart3845);
                    ital_markup();
                    _fsp--;
                    if (failed) return text;
                ...
                case 3 :
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_link_descriptiontext_in_link_descriptionpart3859);
                    	    t=link_descriptiontext();
                    	    _fsp--;
                    	    if (failed) return text;
                    	    pushFollow(FOLLOW_onestar_in_link_descriptionpart3862);
                    	    onestar();
                    	    _fsp--;
                    	    if (failed) return text;
                    	    if ( backtracking==0 ) {
        ...
        try {
            ...
            switch (alt124) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_ital_markup_in_link_bold_descriptionpart3882);
                    ital_markup();
                    _fsp--;
                    if (failed) return text;
                    pushFollow(FOLLOW_link_boldital_description_in_link_bold_descriptionpart3889);
                    ...
                    pushFollow(FOLLOW_ital_markup_in_link_bold_descriptionpart3894);
                    ital_markup();
                    _fsp--;
                    if (failed) return text;
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_link_descriptiontext_in_link_bold_descriptionpart3903);
        ...
        try {
            ...
            switch (alt125) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_bold_markup_in_link_ital_descriptionpart3919);
                    bold_markup();
                    _fsp--;
                    if (failed) return text;
                    pushFollow(FOLLOW_link_boldital_description_in_link_ital_descriptionpart3926);
                    td=link_boldital_description();
                    _fsp--;
                    if (failed) return text;
                    pushFollow(FOLLOW_bold_markup_in_link_ital_descriptionpart3929);
                    bold_markup();
                    _fsp--;
                    if (failed) return text;
                    if ( backtracking==0 ) {
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_link_descriptiontext_in_link_ital_descriptionpart3940);
                    t=link_descriptiontext();
                    _fsp--;
                    if (failed) return text;
                    if ( backtracking==0 ) {
    ...
    public final CollectionNode link_boldital_description() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_onestar_in_link_boldital_description3956);
            onestar();
            _fsp--;
            if (failed) return text;
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_link_descriptiontext_in_link_boldital_description3965);
            	    t=link_descriptiontext();
            	    _fsp--;
            	    if (failed) return text;
            	    pushFollow(FOLLOW_onestar_in_link_boldital_description3968);
            	    onestar();
            	    _fsp--;
            	    if (failed) return text;
            	    if ( backtracking==0 ) {
        ...
        try {
            ...
            switch (alt128) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_link_descriptiontext_simple_in_link_descriptiontext3991);
                ...
                case 2 :
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_forced_linebreak_in_link_descriptiontext4001);
                    	    forced_linebreak();
                    	    _fsp--;
                    	    if (failed) return text;
                    	    if ( backtracking==0 ) {
                    	...
                    	case 2 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_escaped_in_link_descriptiontext4013);
                    	    e=escaped();
                    	    _fsp--;
                    	    if (failed) return text;
                    	    if ( backtracking==0 ) {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    if ( (input.LA(1)>=FORCED_END_OF_LINE && input.LA(1)<=WIKI)||input.LA(1)==POUND||(input.LA(1)>=EQUAL && input.LA(1)<=PIPE)||(input.LA(1)>=NOWIKI_BLOCK_CLOSE && input.LA(1)<=NOWIKI_CLOSE)||(input.LA(1)>=IMAGE_CLOSE && input.LA(1)<=80) ) {
            	        ...
            	        MismatchedSetException mse =
            	            new MismatchedSetException(null,input);
            	        recoverFromMismatchedSet(input,mse,FOLLOW_set_in_link_descriptiontext_simple4038);    throw mse;
            	    }
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    if ( (input.LA(1)>=FORCED_END_OF_LINE && input.LA(1)<=WIKI)||(input.LA(1)>=POUND && input.LA(1)<=EQUAL)||(input.LA(1)>=ITAL && input.LA(1)<=NOWIKI_CLOSE)||(input.LA(1)>=IMAGE_CLOSE && input.LA(1)<=80) ) {
            	        ...
            	        MismatchedSetException mse =
            	            new MismatchedSetException(null,input);
            	        recoverFromMismatchedSet(input,mse,FOLLOW_set_in_link_uri4137);    throw mse;
            	    }
    ...
    public final ImageNode image() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_image_open_markup_in_image4178);
            image_open_markup();
            _fsp--;
            if (failed) return image;
            pushFollow(FOLLOW_image_uri_in_image4184);
            uri=image_uri();
            _fsp--;
            if (failed) return image;
            if ( backtracking==0 ) {
            ...
            switch (alt131) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_image_alternative_in_image4194);
            ...
            pushFollow(FOLLOW_image_close_markup_in_image4203);
            image_close_markup();
            _fsp--;
            if (failed) return image;
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    if ( (input.LA(1)>=FORCED_END_OF_LINE && input.LA(1)<=WIKI)||(input.LA(1)>=POUND && input.LA(1)<=EQUAL)||(input.LA(1)>=ITAL && input.LA(1)<=LINK_CLOSE)||(input.LA(1)>=BLANKS && input.LA(1)<=80) ) {
            	        ...
            	        MismatchedSetException mse =
            	            new MismatchedSetException(null,input);
            	        recoverFromMismatchedSet(input,mse,FOLLOW_set_in_image_uri4222);    throw mse;
            	    }
    ...
    public final CollectionNode image_alternative() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_image_alternative_markup_in_image_alternative4257);
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_image_alternativepart_in_image_alternative4266);
        ...
        try {
            ...
            switch (alt137) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_bold_markup_in_image_alternativepart4292);
                    bold_markup();
                    _fsp--;
                    if (failed) return item;
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_image_bold_alternativepart_in_image_alternativepart4304);
                    	    ...
                    	    pushFollow(FOLLOW_onestar_in_image_alternativepart4309);
                    	    onestar();
                    	    _fsp--;
                    	    if (failed) return item;
                    ...
                    pushFollow(FOLLOW_bold_markup_in_image_alternativepart4316);
                    bold_markup();
                    _fsp--;
                    if (failed) return item;
                    if ( backtracking==0 ) {
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_ital_markup_in_image_alternativepart4323);
                    ital_markup();
                    _fsp--;
                    if (failed) return item;
                    pushFollow(FOLLOW_onestar_in_image_alternativepart4326);
                    onestar();
                    _fsp--;
                    if (failed) return item;
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_image_ital_alternativepart_in_image_alternativepart4336);
                    ...
                    pushFollow(FOLLOW_ital_markup_in_image_alternativepart4348);
                    ital_markup();
                    _fsp--;
                    if (failed) return item;
                    if ( backtracking==0 ) {
                ...
                case 3 :
                    ...
                    {
                    pushFollow(FOLLOW_onestar_in_image_alternativepart4355);
                    onestar();
                    _fsp--;
                    if (failed) return item;
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_image_alternativetext_in_image_alternativepart4362);
        ...
        try {
            ...
            switch (alt139) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_ital_markup_in_image_bold_alternativepart4393);
                    ital_markup();
                    _fsp--;
                    if (failed) return text;
                    pushFollow(FOLLOW_link_boldital_description_in_image_bold_alternativepart4400);
                    t=link_boldital_description();
                    _fsp--;
                    if (failed) return text;
                    if ( backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_ital_markup_in_image_bold_alternativepart4405);
                    ital_markup();
                    _fsp--;
                    if (failed) return text;
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_onestar_in_image_bold_alternativepart4410);
                    onestar();
                    _fsp--;
                    if (failed) return text;
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_image_alternativetext_in_image_bold_alternativepart4419);
                    	    i=image_alternativetext();
                    	    _fsp--;
                    	    if (failed) return text;
                    	    pushFollow(FOLLOW_onestar_in_image_bold_alternativepart4422);
                    	    onestar();
                    	    _fsp--;
                    	    if (failed) return text;
                    	    if ( backtracking==0 ) {
        ...
        try {
            ...
            switch (alt141) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_bold_markup_in_image_ital_alternativepart4450);
                    bold_markup();
                    _fsp--;
                    if (failed) return text;
                    pushFollow(FOLLOW_link_boldital_description_in_image_ital_alternativepart4457);
                    t=link_boldital_description();
                    _fsp--;
                    if (failed) return text;
                    if ( backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_bold_markup_in_image_ital_alternativepart4462);
                    bold_markup();
                    _fsp--;
                    if (failed) return text;
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_onestar_in_image_ital_alternativepart4467);
                    onestar();
                    _fsp--;
                    if (failed) return text;
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_image_alternativetext_in_image_ital_alternativepart4476);
                    	    i=image_alternativetext();
                    	    _fsp--;
                    	    if (failed) return text;
                    	    pushFollow(FOLLOW_onestar_in_image_ital_alternativepart4479);
                    	    onestar();
                    	    _fsp--;
                    	    if (failed) return text;
                    	    if ( backtracking==0 ) {
    ...
    public final CollectionNode image_boldital_alternative() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_onestar_in_image_boldital_alternative4500);
            onestar();
            _fsp--;
            if (failed) return text;
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_image_alternativetext_in_image_boldital_alternative4509);
            	    i=image_alternativetext();
            	    _fsp--;
            	    if (failed) return text;
            	    pushFollow(FOLLOW_onestar_in_image_boldital_alternative4512);
            	    onestar();
            	    _fsp--;
            	    if (failed) return text;
            	    if ( backtracking==0 ) {
        ...
        try {
            ...
            switch (alt144) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_image_alternative_simple_text_in_image_alternativetext4534);
                ...
                case 2 :
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_forced_linebreak_in_image_alternativetext4542);
                    	    forced_linebreak();
                    	    _fsp--;
                    	    if (failed) return items;
                    	    if ( backtracking==0 ) {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    if ( (input.LA(1)>=FORCED_END_OF_LINE && input.LA(1)<=WIKI)||input.LA(1)==POUND||(input.LA(1)>=EQUAL && input.LA(1)<=PIPE)||(input.LA(1)>=ESCAPE && input.LA(1)<=LINK_CLOSE)||(input.LA(1)>=BLANKS && input.LA(1)<=80) ) {
            	        ...
            	        MismatchedSetException mse =
            	            new MismatchedSetException(null,input);
            	        recoverFromMismatchedSet(input,mse,FOLLOW_set_in_image_alternative_simple_text4568);    throw mse;
            	    }
    ...
    public final ASTNode extension() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_extension_markup_in_extension4660);
            extension_markup();
            _fsp--;
            if (failed) return node;
            pushFollow(FOLLOW_extension_handler_in_extension4663);
            extension_handler();
            _fsp--;
            if (failed) return node;
            pushFollow(FOLLOW_blanks_in_extension4666);
            blanks();
            _fsp--;
            if (failed) return node;
            pushFollow(FOLLOW_extension_statement_in_extension4669);
            extension_statement();
            _fsp--;
            if (failed) return node;
            pushFollow(FOLLOW_extension_markup_in_extension4673);
            extension_markup();
            _fsp--;
            if (failed) return node;
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    if ( (input.LA(1)>=FORCED_END_OF_LINE && input.LA(1)<=WIKI)||(input.LA(1)>=POUND && input.LA(1)<=NOWIKI_OPEN)||input.LA(1)==FORCED_LINEBREAK||(input.LA(1)>=NOWIKI_BLOCK_CLOSE && input.LA(1)<=IMAGE_CLOSE)||(input.LA(1)>=DASH && input.LA(1)<=80) ) {
            	        ...
            	        MismatchedSetException mse =
            	            new MismatchedSetException(null,input);
            	        recoverFromMismatchedSet(input,mse,FOLLOW_set_in_extension_handler4685);    throw mse;
            	    }
            	...
            	case 2 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_escaped_in_extension_handler4718);
            	    escaped();
            	    _fsp--;
            	    if (failed) return ;
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    if ( (input.LA(1)>=FORCED_END_OF_LINE && input.LA(1)<=NOWIKI_OPEN)||input.LA(1)==FORCED_LINEBREAK||(input.LA(1)>=NOWIKI_BLOCK_CLOSE && input.LA(1)<=80) ) {
            	        ...
            	        MismatchedSetException mse =
            	            new MismatchedSetException(null,input);
            	        recoverFromMismatchedSet(input,mse,FOLLOW_set_in_extension_statement4733);    throw mse;
            	    }
            	...
            	case 2 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_escaped_in_extension_statement4754);
            	    escaped();
            	    _fsp--;
            	    if (failed) return ;
        ...
        try {
            ...
            switch (alt148) {
                case 1 :
                    ...
                    {
                    match(input,77,FOLLOW_77_in_table_of_contents4782); if (failed) return tableOfContents;
                ...
                case 2 :
                    ...
                    {
                    match(input,78,FOLLOW_78_in_table_of_contents4792); if (failed) return tableOfContents;
                    match(input,79,FOLLOW_79_in_table_of_contents4797); if (failed) return tableOfContents;
                    pushFollow(FOLLOW_table_of_contents_title_text_in_table_of_contents4806);
                    ...
                    match(input,79,FOLLOW_79_in_table_of_contents4813); if (failed) return tableOfContents;
                    match(input,80,FOLLOW_80_in_table_of_contents4818); if (failed) return tableOfContents;
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    if ( (input.LA(1)>=FORCED_END_OF_LINE && input.LA(1)<=WIKI)||(input.LA(1)>=POUND && input.LA(1)<=STAR)||(input.LA(1)>=PIPE && input.LA(1)<=ITAL)||(input.LA(1)>=EXTENSION && input.LA(1)<=FORCED_LINEBREAK)||(input.LA(1)>=NOWIKI_BLOCK_CLOSE && input.LA(1)<=79) ) {
            	        ...
            	        MismatchedSetException mse =
            	            new MismatchedSetException(null,input);
            	        recoverFromMismatchedSet(input,mse,FOLLOW_set_in_table_of_contents_title_text4844);    throw mse;
            	    }
    ...
    public final void onestar() throws RecognitionException {
        try {
            ...
            case PIPE:
                ...
                if ( ((( input.LA(2) != STAR && input.LA(2) == EQUAL )||( input.LA(2) != STAR && input.LA(1) == PIPE && input.LA(2) == PIPE )||(( input.LA(2) != STAR && input.LA(1) == PIPE && input.LA(2) == PIPE )&& input.LA(2) == EQUAL )|| input.LA(2) != STAR )) ) {
                    alt151=1;
                }
                else if ( (true) ) {
                    alt151=2;
                ...
                case 1 :
                    ...
                    switch (alt150) {
                        case 1 :
                            ...
                            {
                            match(input,STAR,FOLLOW_STAR_in_onestar4899); if (failed) return ;
    ...
    public final ScapedNode escaped() throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,ESCAPE,FOLLOW_ESCAPE_in_escaped4920); if (failed) return scaped;
            c=(Token)input.LT(1);
        ...
        try {
            ...
            switch (alt153) {
                case 1 :
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_newline_in_paragraph_separator4944);
                    	    newline();
                    	    _fsp--;
                    	    if (failed) return ;
                ...
                case 2 :
                    ...
                    {
                    match(input,EOF,FOLLOW_EOF_in_paragraph_separator4952); if (failed) return ;
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_blanks_in_whitespaces4964);
            	    blanks();
            	    _fsp--;
            	    if (failed) return ;
            	...
            	case 2 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_newline_in_whitespaces4968);
            	    newline();
            	    _fsp--;
            	    if (failed) return ;
    ...
    public final void blanks() throws RecognitionException {
        try {
            ...
            {
            match(input,BLANKS,FOLLOW_BLANKS_in_blanks4981); if (failed) return ;
        ...
        try {
            ...
            switch (alt156) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_newline_in_text_lineseparator4991);
                    newline();
                    _fsp--;
                    if (failed) return ;
                    ...
                    switch (alt155) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_blanks_in_text_lineseparator4996);
                            blanks();
                            _fsp--;
                            if (failed) return ;
                ...
                case 2 :
                    ...
                    {
                    match(input,EOF,FOLLOW_EOF_in_text_lineseparator5004); if (failed) return ;
    ...
    public final void newline() throws RecognitionException {
        try {
            ...
            {
            match(input,NEWLINE,FOLLOW_NEWLINE_in_newline5014); if (failed) return ;
    ...
    public final void bold_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,STAR,FOLLOW_STAR_in_bold_markup5024); if (failed) return ;
            match(input,STAR,FOLLOW_STAR_in_bold_markup5027); if (failed) return ;
    ...
    public final void ital_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,ITAL,FOLLOW_ITAL_in_ital_markup5037); if (failed) return ;
    ...
    public final void heading_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,EQUAL,FOLLOW_EQUAL_in_heading_markup5047); if (failed) return ;
    ...
    public final list_ordelem_markup_return list_ordelem_markup() throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,POUND,FOLLOW_POUND_in_list_ordelem_markup5057); if (failed) return retval;
    ...
    public final list_unordelem_markup_return list_unordelem_markup() throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,STAR,FOLLOW_STAR_in_list_unordelem_markup5067); if (failed) return retval;
        ...
        try {
            ...
            switch (alt158) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_newline_in_list_elemseparator5077);
                    newline();
                    _fsp--;
                    if (failed) return ;
                    ...
                    switch (alt157) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_blanks_in_list_elemseparator5082);
                            blanks();
                            _fsp--;
                            if (failed) return ;
                ...
                case 2 :
                    ...
                    {
                    match(input,EOF,FOLLOW_EOF_in_list_elemseparator5090); if (failed) return ;
        ...
        try {
            ...
            switch (alt159) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_newline_in_end_of_list5100);
                    newline();
                    _fsp--;
                    if (failed) return ;
                ...
                case 2 :
                    ...
                    {
                    match(input,EOF,FOLLOW_EOF_in_end_of_list5105); if (failed) return ;
    ...
    public final void table_cell_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,PIPE,FOLLOW_PIPE_in_table_cell_markup5115); if (failed) return ;
    ...
    public final void table_headercell_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,PIPE,FOLLOW_PIPE_in_table_headercell_markup5125); if (failed) return ;
            match(input,EQUAL,FOLLOW_EQUAL_in_table_headercell_markup5128); if (failed) return ;
        ...
        try {
            ...
            switch (alt160) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_newline_in_table_rowseparator5138);
                    newline();
                    _fsp--;
                    if (failed) return ;
                ...
                case 2 :
                    ...
                    {
                    match(input,EOF,FOLLOW_EOF_in_table_rowseparator5143); if (failed) return ;
    ...
    public final void nowiki_open_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,NOWIKI_OPEN,FOLLOW_NOWIKI_OPEN_in_nowiki_open_markup5153); if (failed) return ;
    ...
    public final void nowiki_close_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,NOWIKI_CLOSE,FOLLOW_NOWIKI_CLOSE_in_nowiki_close_markup5163); if (failed) return ;
    ...
    public final void horizontalrule_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,DASH,FOLLOW_DASH_in_horizontalrule_markup5173); if (failed) return ;
            match(input,DASH,FOLLOW_DASH_in_horizontalrule_markup5176); if (failed) return ;
            match(input,DASH,FOLLOW_DASH_in_horizontalrule_markup5179); if (failed) return ;
            match(input,DASH,FOLLOW_DASH_in_horizontalrule_markup5182); if (failed) return ;
    ...
    public final void link_open_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,LINK_OPEN,FOLLOW_LINK_OPEN_in_link_open_markup5192); if (failed) return ;
    ...
    public final void link_close_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,LINK_CLOSE,FOLLOW_LINK_CLOSE_in_link_close_markup5202); if (failed) return ;
    ...
    public final void link_description_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,PIPE,FOLLOW_PIPE_in_link_description_markup5212); if (failed) return ;
    ...
    public final void image_open_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,IMAGE_OPEN,FOLLOW_IMAGE_OPEN_in_image_open_markup5222); if (failed) return ;
    ...
    public final void image_close_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,IMAGE_CLOSE,FOLLOW_IMAGE_CLOSE_in_image_close_markup5232); if (failed) return ;
    ...
    public final void image_alternative_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,PIPE,FOLLOW_PIPE_in_image_alternative_markup5242); if (failed) return ;
    ...
    public final void extension_markup() throws RecognitionException {
        try {
            ...
            {
            match(input,EXTENSION,FOLLOW_EXTENSION_in_extension_markup5252); if (failed) return ;
    ...
    public final void forced_linebreak() throws RecognitionException {
        try {
            ...
            {
            match(input,FORCED_LINEBREAK,FOLLOW_FORCED_LINEBREAK_in_forced_linebreak5262); if (failed) return ;
    ...
    public static final BitSet FOLLOW_table_cell_in_table_row2363 = new BitSet(new long[]{0x0000000000088000L});
    public static final BitSet FOLLOW_table_rowseparator_in_table_row2372 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_table_headercell_in_table_cell2393 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_table_normalcell_in_table_cell2404 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_table_headercell_markup_in_table_headercell2420 = new BitSet(new long[]{0xFFFFFFFFFFF77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_table_cellcontent_in_table_headercell2427 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_table_cell_markup_in_table_normalcell2443 = new BitSet(new long[]{0xFFFFFFFFFFF77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_table_cellcontent_in_table_normalcell2450 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_onestar_in_table_cellcontent2466 = new BitSet(new long[]{0xFFFFFFFFFFF77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_table_cellcontentpart_in_table_cellcontent2475 = new BitSet(new long[]{0xFFFFFFFFFFF77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_onestar_in_table_cellcontent2482 = new BitSet(new long[]{0xFFFFFFFFFFF77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_table_formattedelement_in_table_cellcontentpart2503 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_table_unformattedelement_in_table_cellcontentpart2514 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ital_markup_in_table_formattedelement2530 = new BitSet(new long[]{0xFFFFFFFFFFF77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_table_italcontent_in_table_formattedelement2540 = new BitSet(new long[]{0x0000000000100002L});
    public static final BitSet FOLLOW_ital_markup_in_table_formattedelement2549 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_bold_markup_in_table_formattedelement2557 = new BitSet(new long[]{0xFFFFFFFFFFF77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_table_boldcontent_in_table_formattedelement2564 = new BitSet(new long[]{0x0000000000020002L});
    public static final BitSet FOLLOW_bold_markup_in_table_formattedelement2574 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_onestar_in_table_boldcontent2591 = new BitSet(new long[]{0xFFFFFFFFFFF57FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_table_boldcontentpart_in_table_boldcontent2600 = new BitSet(new long[]{0xFFFFFFFFFFF77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_onestar_in_table_boldcontent2605 = new BitSet(new long[]{0xFFFFFFFFFFF57FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_EOF_in_table_boldcontent2613 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_onestar_in_table_italcontent2627 = new BitSet(new long[]{0xFFFFFFFFFFE77FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_table_italcontentpart_in_table_italcontent2636 = new BitSet(new long[]{0xFFFFFFFFFFE77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_onestar_in_table_italcontent2641 = new BitSet(new long[]{0xFFFFFFFFFFE77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_EOF_in_table_italcontent2649 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_table_formattedcontent_in_table_boldcontentpart2667 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ital_markup_in_table_boldcontentpart2674 = new BitSet(new long[]{0xFFFFFFFFFFF77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_table_bolditalcontent_in_table_boldcontentpart2681 = new BitSet(new long[]{0x0000000000100002L});
    public static final BitSet FOLLOW_ital_markup_in_table_boldcontentpart2688 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_bold_markup_in_table_italcontentpart2705 = new BitSet(new long[]{0xFFFFFFFFFFE77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_table_bolditalcontent_in_table_italcontentpart2712 = new BitSet(new long[]{0x0000000000020002L});
    public static final BitSet FOLLOW_bold_markup_in_table_italcontentpart2719 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_table_formattedcontent_in_table_italcontentpart2731 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_onestar_in_table_bolditalcontent2747 = new BitSet(new long[]{0xFFFFFFFFFFE57FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_table_formattedcontent_in_table_bolditalcontent2756 = new BitSet(new long[]{0x0000000000020002L});
    public static final BitSet FOLLOW_onestar_in_table_bolditalcontent2761 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EOF_in_table_bolditalcontent2769 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_table_unformattedelement_in_table_formattedcontent2789 = new BitSet(new long[]{0xFFFFFFFFFFE57FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_table_unformatted_in_table_unformattedelement2812 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_table_inlineelement_in_table_unformattedelement2824 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_link_in_table_inlineelement2844 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_image_in_table_inlineelement2854 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_extension_in_table_inlineelement2865 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_nowiki_inline_in_table_inlineelement2875 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_table_unformatted_text_in_table_unformatted2896 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_forced_linebreak_in_table_unformatted2905 = new BitSet(new long[]{0x0000000006000002L});
    public static final BitSet FOLLOW_escaped_in_table_unformatted2917 = new BitSet(new long[]{0x0000000006000002L});
    public static final BitSet FOLLOW_set_in_table_unformatted_text2943 = new BitSet(new long[]{0xFFFFFFFFF8057FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_nowikiblock_open_markup_in_nowiki_block3040 = new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_nowiki_block_contents_in_nowiki_block3047 = new BitSet(new long[]{0x0000000008000000L});
    public static final BitSet FOLLOW_nowikiblock_close_markup_in_nowiki_block3053 = new BitSet(new long[]{0x0000000000008000L});
    public static final BitSet FOLLOW_paragraph_separator_in_nowiki_block3056 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_nowiki_open_markup_in_nowikiblock_open_markup3067 = new BitSet(new long[]{0x0000000000008000L});
    public static final BitSet FOLLOW_newline_in_nowikiblock_open_markup3070 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NOWIKI_BLOCK_CLOSE_in_nowikiblock_close_markup3081 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_nowiki_open_markup_in_nowiki_inline3096 = new BitSet(new long[]{0xFFFFFFFFFFFF7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_nowiki_inline_contents_in_nowiki_inline3103 = new BitSet(new long[]{0x0000000010000000L});
    public static final BitSet FOLLOW_nowiki_close_markup_in_nowiki_inline3107 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_nowiki_block_contents3125 = new BitSet(new long[]{0xFFFFFFFFF7FFFFF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_set_in_nowiki_inline_contents3158 = new BitSet(new long[]{0xFFFFFFFFEFFF7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_horizontalrule_markup_in_horizontalrule3194 = new BitSet(new long[]{0x0000000080008000L});
    public static final BitSet FOLLOW_blanks_in_horizontalrule3199 = new BitSet(new long[]{0x0000000000008000L});
    public static final BitSet FOLLOW_paragraph_separator_in_horizontalrule3205 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_link_open_markup_in_link3226 = new BitSet(new long[]{0xFFFFFFFFDFF77FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_link_address_in_link3232 = new BitSet(new long[]{0x0000000020080000L});
    public static final BitSet FOLLOW_link_description_markup_in_link3238 = new BitSet(new long[]{0xFFFFFFFFDE5F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_link_description_in_link3246 = new BitSet(new long[]{0x0000000020000000L});
    public static final BitSet FOLLOW_link_close_markup_in_link3254 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_link_interwiki_uri_in_link_address3273 = new BitSet(new long[]{0x0000020000000000L});
    public static final BitSet FOLLOW_41_in_link_address3276 = new BitSet(new long[]{0xFFFFFFFFDFF77FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_link_interwiki_pagename_in_link_address3283 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_link_uri_in_link_address3294 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_42_in_link_interwiki_uri3310 = new BitSet(new long[]{0x0000080000000000L});
    public static final BitSet FOLLOW_43_in_link_interwiki_uri3312 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_44_in_link_interwiki_uri3319 = new BitSet(new long[]{0x0000200000000000L});
    public static final BitSet FOLLOW_45_in_link_interwiki_uri3321 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_link_interwiki_uri3323 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_47_in_link_interwiki_uri3325 = new BitSet(new long[]{0x0001000000000000L});
    public static final BitSet FOLLOW_48_in_link_interwiki_uri3327 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3329 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_link_interwiki_uri3331 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3333 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_50_in_link_interwiki_uri3340 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_51_in_link_interwiki_uri3342 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3344 = new BitSet(new long[]{0x0010000000000000L});
    public static final BitSet FOLLOW_52_in_link_interwiki_uri3346 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_link_interwiki_uri3348 = new BitSet(new long[]{0x0020000000000000L});
    public static final BitSet FOLLOW_53_in_link_interwiki_uri3350 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_54_in_link_interwiki_uri3358 = new BitSet(new long[]{0x0000200000000000L});
    public static final BitSet FOLLOW_45_in_link_interwiki_uri3360 = new BitSet(new long[]{0x0000200000000000L});
    public static final BitSet FOLLOW_45_in_link_interwiki_uri3362 = new BitSet(new long[]{0x0080000000000000L});
    public static final BitSet FOLLOW_55_in_link_interwiki_uri3364 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_51_in_link_interwiki_uri3366 = new BitSet(new long[]{0x0100000000000000L});
    public static final BitSet FOLLOW_56_in_link_interwiki_uri3368 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_57_in_link_interwiki_uri3375 = new BitSet(new long[]{0x0400000000000000L});
    public static final BitSet FOLLOW_58_in_link_interwiki_uri3377 = new BitSet(new long[]{0x0800000000000000L});
    public static final BitSet FOLLOW_59_in_link_interwiki_uri3379 = new BitSet(new long[]{0x0001000000000000L});
    public static final BitSet FOLLOW_48_in_link_interwiki_uri3381 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3383 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_link_interwiki_uri3385 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3387 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_60_in_link_interwiki_uri3394 = new BitSet(new long[]{0x0100000000000000L});
    public static final BitSet FOLLOW_56_in_link_interwiki_uri3396 = new BitSet(new long[]{0x2000000000000000L});
    public static final BitSet FOLLOW_61_in_link_interwiki_uri3398 = new BitSet(new long[]{0x4000000000000000L});
    public static final BitSet FOLLOW_62_in_link_interwiki_uri3400 = new BitSet(new long[]{0x8000000000000000L});
    public static final BitSet FOLLOW_63_in_link_interwiki_uri3402 = new BitSet(new long[]{0x2000000000000000L});
    public static final BitSet FOLLOW_61_in_link_interwiki_uri3404 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_51_in_link_interwiki_uri3406 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_51_in_link_interwiki_uri3408 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_60_in_link_interwiki_uri3415 = new BitSet(new long[]{0x0100000000000000L});
    public static final BitSet FOLLOW_56_in_link_interwiki_uri3417 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_64_in_link_interwiki_uri3419 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3421 = new BitSet(new long[]{0x2000000000000000L});
    public static final BitSet FOLLOW_61_in_link_interwiki_uri3423 = new BitSet(new long[]{0x0001000000000000L});
    public static final BitSet FOLLOW_48_in_link_interwiki_uri3425 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3427 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_link_interwiki_uri3429 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3431 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_60_in_link_interwiki_uri3438 = new BitSet(new long[]{0x0000200000000000L});
    public static final BitSet FOLLOW_45_in_link_interwiki_uri3440 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3442 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000002L});
    public static final BitSet FOLLOW_65_in_link_interwiki_uri3444 = new BitSet(new long[]{0x1000000000000000L});
    public static final BitSet FOLLOW_60_in_link_interwiki_uri3446 = new BitSet(new long[]{0x0000200000000000L});
    public static final BitSet FOLLOW_45_in_link_interwiki_uri3448 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3450 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000002L});
    public static final BitSet FOLLOW_65_in_link_interwiki_uri3452 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_66_in_link_interwiki_uri3460 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_64_in_link_interwiki_uri3462 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_64_in_link_interwiki_uri3464 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000008L});
    public static final BitSet FOLLOW_67_in_link_interwiki_uri3466 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_47_in_link_interwiki_uri3468 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000010L});
    public static final BitSet FOLLOW_68_in_link_interwiki_uri3470 = new BitSet(new long[]{0x0100000000000000L});
    public static final BitSet FOLLOW_56_in_link_interwiki_uri3472 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_66_in_link_interwiki_uri3480 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000020L});
    public static final BitSet FOLLOW_69_in_link_interwiki_uri3482 = new BitSet(new long[]{0x2000000000000000L});
    public static final BitSet FOLLOW_61_in_link_interwiki_uri3484 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000002L});
    public static final BitSet FOLLOW_65_in_link_interwiki_uri3486 = new BitSet(new long[]{0x2000000000000000L});
    public static final BitSet FOLLOW_61_in_link_interwiki_uri3488 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_59_in_link_interwiki_uri3495 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000008L});
    public static final BitSet FOLLOW_67_in_link_interwiki_uri3497 = new BitSet(new long[]{0x0001000000000000L});
    public static final BitSet FOLLOW_48_in_link_interwiki_uri3499 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3501 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_link_interwiki_uri3503 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3505 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_59_in_link_interwiki_uri3513 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_47_in_link_interwiki_uri3515 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_link_interwiki_uri3517 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3519 = new BitSet(new long[]{0x0001000000000000L});
    public static final BitSet FOLLOW_48_in_link_interwiki_uri3521 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3523 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_link_interwiki_uri3525 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3527 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_59_in_link_interwiki_uri3535 = new BitSet(new long[]{0x0000800000000000L});
    public static final BitSet FOLLOW_47_in_link_interwiki_uri3537 = new BitSet(new long[]{0x0020000000000000L});
    public static final BitSet FOLLOW_53_in_link_interwiki_uri3539 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_70_in_link_interwiki_uri3541 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_51_in_link_interwiki_uri3543 = new BitSet(new long[]{0x0100000000000000L});
    public static final BitSet FOLLOW_56_in_link_interwiki_uri3545 = new BitSet(new long[]{0x0001000000000000L});
    public static final BitSet FOLLOW_48_in_link_interwiki_uri3547 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3549 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_link_interwiki_uri3551 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3553 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_71_in_link_interwiki_uri3560 = new BitSet(new long[]{0x2000000000000000L});
    public static final BitSet FOLLOW_61_in_link_interwiki_uri3562 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_64_in_link_interwiki_uri3564 = new BitSet(new long[]{0x0100000000000000L});
    public static final BitSet FOLLOW_56_in_link_interwiki_uri3566 = new BitSet(new long[]{0x0000200000000000L});
    public static final BitSet FOLLOW_45_in_link_interwiki_uri3568 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000100L});
    public static final BitSet FOLLOW_72_in_link_interwiki_uri3570 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_58_in_link_interwiki_uri3577 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000002L});
    public static final BitSet FOLLOW_65_in_link_interwiki_uri3579 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3581 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_70_in_link_interwiki_uri3583 = new BitSet(new long[]{0x0400000000000000L});
    public static final BitSet FOLLOW_58_in_link_interwiki_uri3585 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000002L});
    public static final BitSet FOLLOW_65_in_link_interwiki_uri3587 = new BitSet(new long[]{0x2000000000000000L});
    public static final BitSet FOLLOW_61_in_link_interwiki_uri3589 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_70_in_link_interwiki_uri3591 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_73_in_link_interwiki_uri3598 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3600 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_64_in_link_interwiki_uri3602 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_64_in_link_interwiki_uri3604 = new BitSet(new long[]{0x0008000000000000L});
    public static final BitSet FOLLOW_51_in_link_interwiki_uri3606 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000400L});
    public static final BitSet FOLLOW_74_in_link_interwiki_uri3608 = new BitSet(new long[]{0x0001000000000000L});
    public static final BitSet FOLLOW_48_in_link_interwiki_uri3610 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3612 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_link_interwiki_uri3614 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3616 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_73_in_link_interwiki_uri3623 = new BitSet(new long[]{0x0001000000000000L});
    public static final BitSet FOLLOW_48_in_link_interwiki_uri3625 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3627 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_link_interwiki_uri3629 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3631 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_75_in_link_interwiki_uri3638 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000010L});
    public static final BitSet FOLLOW_68_in_link_interwiki_uri3640 = new BitSet(new long[]{0x0100000000000000L});
    public static final BitSet FOLLOW_56_in_link_interwiki_uri3642 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000008L});
    public static final BitSet FOLLOW_67_in_link_interwiki_uri3644 = new BitSet(new long[]{0x0000200000000000L});
    public static final BitSet FOLLOW_45_in_link_interwiki_uri3646 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_64_in_link_interwiki_uri3648 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_48_in_link_interwiki_uri3655 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3657 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_link_interwiki_uri3659 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3661 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_70_in_link_interwiki_uri3663 = new BitSet(new long[]{0x0100000000000000L});
    public static final BitSet FOLLOW_56_in_link_interwiki_uri3665 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_64_in_link_interwiki_uri3667 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3669 = new BitSet(new long[]{0x2000000000000000L});
    public static final BitSet FOLLOW_61_in_link_interwiki_uri3671 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_76_in_link_interwiki_uri3678 = new BitSet(new long[]{0x0001000000000000L});
    public static final BitSet FOLLOW_48_in_link_interwiki_uri3680 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3682 = new BitSet(new long[]{0x0000400000000000L});
    public static final BitSet FOLLOW_46_in_link_interwiki_uri3684 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_49_in_link_interwiki_uri3686 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_link_interwiki_pagename3708 = new BitSet(new long[]{0xFFFFFFFFDFF77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_link_descriptionpart_in_link_description3751 = new BitSet(new long[]{0xFFFFFFFFDE5F7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_image_in_link_description3763 = new BitSet(new long[]{0xFFFFFFFFDE5F7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_bold_markup_in_link_descriptionpart3788 = new BitSet(new long[]{0xFFFFFFFFDE1F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_onestar_in_link_descriptionpart3791 = new BitSet(new long[]{0xFFFFFFFFDE1D7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_link_bold_descriptionpart_in_link_descriptionpart3799 = new BitSet(new long[]{0xFFFFFFFFDE1F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_onestar_in_link_descriptionpart3804 = new BitSet(new long[]{0xFFFFFFFFDE1F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_bold_markup_in_link_descriptionpart3814 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ital_markup_in_link_descriptionpart3819 = new BitSet(new long[]{0xFFFFFFFFDE0F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_onestar_in_link_descriptionpart3822 = new BitSet(new long[]{0xFFFFFFFFDE0F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_link_ital_descriptionpart_in_link_descriptionpart3831 = new BitSet(new long[]{0xFFFFFFFFDE1F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_onestar_in_link_descriptionpart3836 = new BitSet(new long[]{0xFFFFFFFFDE1F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_ital_markup_in_link_descriptionpart3845 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_onestar_in_link_descriptionpart3850 = new BitSet(new long[]{0xFFFFFFFFDE0D7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_link_descriptiontext_in_link_descriptionpart3859 = new BitSet(new long[]{0xFFFFFFFFDE0F7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_onestar_in_link_descriptionpart3862 = new BitSet(new long[]{0xFFFFFFFFDE0D7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_ital_markup_in_link_bold_descriptionpart3882 = new BitSet(new long[]{0xFFFFFFFFDE0F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_link_boldital_description_in_link_bold_descriptionpart3889 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_ital_markup_in_link_bold_descriptionpart3894 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_link_descriptiontext_in_link_bold_descriptionpart3903 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_bold_markup_in_link_ital_descriptionpart3919 = new BitSet(new long[]{0xFFFFFFFFDE0F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_link_boldital_description_in_link_ital_descriptionpart3926 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_bold_markup_in_link_ital_descriptionpart3929 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_link_descriptiontext_in_link_ital_descriptionpart3940 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_onestar_in_link_boldital_description3956 = new BitSet(new long[]{0xFFFFFFFFDE0D7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_link_descriptiontext_in_link_boldital_description3965 = new BitSet(new long[]{0xFFFFFFFFDE0F7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_onestar_in_link_boldital_description3968 = new BitSet(new long[]{0xFFFFFFFFDE0D7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_link_descriptiontext_simple_in_link_descriptiontext3991 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_forced_linebreak_in_link_descriptiontext4001 = new BitSet(new long[]{0x0000000006000002L});
    public static final BitSet FOLLOW_escaped_in_link_descriptiontext4013 = new BitSet(new long[]{0x0000000006000002L});
    public static final BitSet FOLLOW_set_in_link_descriptiontext_simple4038 = new BitSet(new long[]{0xFFFFFFFFD80D7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_set_in_link_uri4137 = new BitSet(new long[]{0xFFFFFFFFDFF77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_image_open_markup_in_image4178 = new BitSet(new long[]{0xFFFFFFFFBFF77FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_image_uri_in_image4184 = new BitSet(new long[]{0x0000000040080000L});
    public static final BitSet FOLLOW_image_alternative_in_image4194 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_image_close_markup_in_image4203 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_image_uri4222 = new BitSet(new long[]{0xFFFFFFFFBFF77FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_image_alternative_markup_in_image_alternative4257 = new BitSet(new long[]{0xFFFFFFFFBE1F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_image_alternativepart_in_image_alternative4266 = new BitSet(new long[]{0xFFFFFFFFBE1F7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_bold_markup_in_image_alternativepart4292 = new BitSet(new long[]{0x0000000000120000L});
    ...
    public static final BitSet FOLLOW_image_bold_alternativepart_in_image_alternativepart4304 = new BitSet(new long[]{0x0000000000120000L});
    public static final BitSet FOLLOW_onestar_in_image_alternativepart4309 = new BitSet(new long[]{0xFFFFFFFFBE1F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_bold_markup_in_image_alternativepart4316 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ital_markup_in_image_alternativepart4323 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_onestar_in_image_alternativepart4326 = new BitSet(new long[]{0xFFFFFFFFBE0F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_image_ital_alternativepart_in_image_alternativepart4336 = new BitSet(new long[]{0x0000000000120000L});
    public static final BitSet FOLLOW_onestar_in_image_alternativepart4341 = new BitSet(new long[]{0xFFFFFFFFBE1F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_ital_markup_in_image_alternativepart4348 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_onestar_in_image_alternativepart4355 = new BitSet(new long[]{0xFFFFFFFFBE0D7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_image_alternativetext_in_image_alternativepart4362 = new BitSet(new long[]{0xFFFFFFFFBE0F7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_onestar_in_image_alternativepart4367 = new BitSet(new long[]{0xFFFFFFFFBE0D7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_ital_markup_in_image_bold_alternativepart4393 = new BitSet(new long[]{0xFFFFFFFFDE0F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_link_boldital_description_in_image_bold_alternativepart4400 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_ital_markup_in_image_bold_alternativepart4405 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_onestar_in_image_bold_alternativepart4410 = new BitSet(new long[]{0xFFFFFFFFBE0D7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_image_alternativetext_in_image_bold_alternativepart4419 = new BitSet(new long[]{0xFFFFFFFFBE0F7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_onestar_in_image_bold_alternativepart4422 = new BitSet(new long[]{0xFFFFFFFFBE0D7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_bold_markup_in_image_ital_alternativepart4450 = new BitSet(new long[]{0xFFFFFFFFDE0F7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_link_boldital_description_in_image_ital_alternativepart4457 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_bold_markup_in_image_ital_alternativepart4462 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_onestar_in_image_ital_alternativepart4467 = new BitSet(new long[]{0xFFFFFFFFBE0D7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_image_alternativetext_in_image_ital_alternativepart4476 = new BitSet(new long[]{0xFFFFFFFFBE0F7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_onestar_in_image_ital_alternativepart4479 = new BitSet(new long[]{0xFFFFFFFFBE0D7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_onestar_in_image_boldital_alternative4500 = new BitSet(new long[]{0xFFFFFFFFBE0D7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_image_alternativetext_in_image_boldital_alternative4509 = new BitSet(new long[]{0xFFFFFFFFBE0F7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_onestar_in_image_boldital_alternative4512 = new BitSet(new long[]{0xFFFFFFFFBE0D7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_image_alternative_simple_text_in_image_alternativetext4534 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_forced_linebreak_in_image_alternativetext4542 = new BitSet(new long[]{0x0000000002000002L});
    public static final BitSet FOLLOW_set_in_image_alternative_simple_text4568 = new BitSet(new long[]{0xFFFFFFFFBC0D7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_extension_markup_in_extension4660 = new BitSet(new long[]{0xFFFFFFFF7EFF7FF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_extension_handler_in_extension4663 = new BitSet(new long[]{0x0000000080000000L});
    public static final BitSet FOLLOW_blanks_in_extension4666 = new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_extension_statement_in_extension4669 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_extension_markup_in_extension4673 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_extension_handler4685 = new BitSet(new long[]{0xFFFFFFFF7EFF7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_escaped_in_extension_handler4718 = new BitSet(new long[]{0xFFFFFFFF7EFF7FF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_set_in_extension_statement4733 = new BitSet(new long[]{0xFFFFFFFFFEFFFFF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_escaped_in_extension_statement4754 = new BitSet(new long[]{0xFFFFFFFFFEFFFFF2L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_77_in_table_of_contents4782 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_78_in_table_of_contents4792 = new BitSet(new long[]{0x0000000000000000L,0x0000000000008000L});
    public static final BitSet FOLLOW_79_in_table_of_contents4797 = new BitSet(new long[]{0xFFFFFFFFFB1B7FF0L,0x000000000000FFFFL});
    public static final BitSet FOLLOW_table_of_contents_title_text_in_table_of_contents4806 = new BitSet(new long[]{0x0000000000000000L,0x0000000000008000L});
    public static final BitSet FOLLOW_79_in_table_of_contents4813 = new BitSet(new long[]{0x0000000000000000L,0x0000000000010000L});
    public static final BitSet FOLLOW_80_in_table_of_contents4818 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_table_of_contents_title_text4844 = new BitSet(new long[]{0xFFFFFFFFFB1B7FF2L,0x000000000000FFFFL});
    public static final BitSet FOLLOW_STAR_in_onestar4899 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ESCAPE_in_escaped4920 = new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L,0x000000000001FFFFL});
    public static final BitSet FOLLOW_newline_in_paragraph_separator4944 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_EOF_in_paragraph_separator4952 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_blanks_in_whitespaces4964 = new BitSet(new long[]{0x0000000080008002L});
    public static final BitSet FOLLOW_newline_in_whitespaces4968 = new BitSet(new long[]{0x0000000080008002L});
    public static final BitSet FOLLOW_BLANKS_in_blanks4981 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_newline_in_text_lineseparator4991 = new BitSet(new long[]{0x0000000080000002L});
    public static final BitSet FOLLOW_blanks_in_text_lineseparator4996 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EOF_in_text_lineseparator5004 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NEWLINE_in_newline5014 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STAR_in_bold_markup5024 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_STAR_in_bold_markup5027 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ITAL_in_ital_markup5037 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EQUAL_in_heading_markup5047 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_POUND_in_list_ordelem_markup5057 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STAR_in_list_unordelem_markup5067 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_newline_in_list_elemseparator5077 = new BitSet(new long[]{0x0000000080000002L});
    public static final BitSet FOLLOW_blanks_in_list_elemseparator5082 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EOF_in_list_elemseparator5090 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_newline_in_end_of_list5100 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EOF_in_end_of_list5105 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_PIPE_in_table_cell_markup5115 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_PIPE_in_table_headercell_markup5125 = new BitSet(new long[]{0x0000000000040000L});
    public static final BitSet FOLLOW_EQUAL_in_table_headercell_markup5128 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_newline_in_table_rowseparator5138 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EOF_in_table_rowseparator5143 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NOWIKI_OPEN_in_nowiki_open_markup5153 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NOWIKI_CLOSE_in_nowiki_close_markup5163 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DASH_in_horizontalrule_markup5173 = new BitSet(new long[]{0x0000000100000000L});
    public static final BitSet FOLLOW_DASH_in_horizontalrule_markup5176 = new BitSet(new long[]{0x0000000100000000L});
    public static final BitSet FOLLOW_DASH_in_horizontalrule_markup5179 = new BitSet(new long[]{0x0000000100000000L});
    public static final BitSet FOLLOW_DASH_in_horizontalrule_markup5182 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LINK_OPEN_in_link_open_markup5192 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LINK_CLOSE_in_link_close_markup5202 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_PIPE_in_link_description_markup5212 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_IMAGE_OPEN_in_image_open_markup5222 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_IMAGE_CLOSE_in_image_close_markup5232 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_PIPE_in_image_alternative_markup5242 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EXTENSION_in_extension_markup5252 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_FORCED_LINEBREAK_in_forced_linebreak5262 = new BitSet(new long[]{0x0000000000000002L});
