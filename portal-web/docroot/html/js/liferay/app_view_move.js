AUI.add(
	...
	'',
	{
		requires: ['aui-base', 'dd-constrain', 'dd-delegate', 'dd-drag', 'dd-drop', 'dd-proxy', 'liferay-history-manager', 'liferay-language', 'liferay-portlet-base', 'liferay-util-list-fields']
	}
);