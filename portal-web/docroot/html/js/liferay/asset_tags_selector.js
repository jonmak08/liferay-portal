				...
				prototype: {
					...
					_showSelectPopup: function(event) {
						...
						instance._getEntries(
							function(entries) {
								if (!popup.AutocompleteSearchList) {
						...
						instance._hideNode(searchFieldNode.ancestor());
						instance._hideNode(popup.entriesNode);

						if (autocompleteSearchList) {
							instance._showNode(autocompleteSearchList.entriesNode);
							instance._showNode(autocompleteSearchList.inputNode);
						}
					},
					...
					_showSuggestionsPopup: function(event) {
						...
						instance._showNode(searchFieldNode.ancestor());
						instance._hideNode(popup.entriesNode);

						if (autocompleteSearchList) {
							instance._hideNode(autocompleteSearchList.entriesNode);
							instance._hideNode(autocompleteSearchList.inputNode);
						}
