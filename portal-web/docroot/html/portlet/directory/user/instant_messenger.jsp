	...
	<dl class="property-list">
		...
		<c:if test="<%= Validator.isNotNull(skype) %>">
			...
			<dd>
				...
				<a href="callto://<%= HtmlUtil.escapeAttribute(skype) %>"><img alt="<%= HtmlUtil.escapeAttribute(LanguageUtil.get(call-this-user)) %>" class="instant-messenger-logo" src="http://mystatus.skype.com/smallicon/<%= HtmlUtil.escapeAttribute(skype) %>" /></a>
			</dd>
		</c:if>
