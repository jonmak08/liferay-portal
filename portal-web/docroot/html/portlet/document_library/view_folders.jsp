...
portletURL.setParameter("curEntry", HttpUtil.getParameter(currentURL, "_20_curEntry", false));
portletURL.setParameter("deltaEntry", HttpUtil.getParameter(currentURL, "_20_deltaEntry", false));
