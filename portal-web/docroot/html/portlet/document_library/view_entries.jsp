...
portletURL.setParameter("curFolder", HttpUtil.getParameter(currentURL, "_20_curFolder", false));
portletURL.setParameter("deltaFolder", HttpUtil.getParameter(currentURL, "_20_deltaFolder", false));
