AUI.add(
	...
	'',
	{
		requires: ['arraysort', 'aui-form-builder', 'aui-form-validator', 'aui-text-unicode', 'json', 'liferay-language', 'liferay-menu', 'liferay-translation-manager', 'liferay-util-window', 'text']
	}
);