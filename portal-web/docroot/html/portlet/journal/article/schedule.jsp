...
<aui:fieldset>
	...
	<aui:input disabled="<%= neverExpire %>" formName="fm1" name="expirationDate" disableController="neverExpire" />
	...
	<aui:input disabled="<%= neverReview %>" formName="fm1" name="reviewDate" disableController="neverReview" />
