					...
					<tr>
						<td>
							...
							<tr>
								...
								<td>
									<aui:input field="discount" fieldParam='<%= "discount" + i %>' ignoreRequestValue="<%= true %>" format="<%= doubleFormat %>" label="discount" model="<%= ShoppingItemPrice.class %>" name="discount" value="<%= String.valueOf(discount*100) %>" suffix="<%= StringPool.PERCENT %>" />
								</td>
								<td>
