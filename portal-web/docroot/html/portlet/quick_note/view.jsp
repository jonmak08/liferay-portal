		...
		<tr>
			...
			<td>
				<c:if test="<%= portletDisplay.isShowCloseIcon() %>">
					<a border="0" class="close-note" href="<%= portletDisplay.getURLClose() %>"><img alt="<%= HtmlUtil.escapeAttribute(LanguageUtil.get(close)) %>" src="<%= themeDisplay.getPathThemeImages() %>/portlet/close.png" /></a>
				</c:if>
