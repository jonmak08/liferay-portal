	...
	<c:otherwise>
		...
		<aui:form action="<%= portletURL %>" method="post" name="fm">
			...
			%>
				...
				<aui:input cssClass="lfr-input-text-container" hideAccessibleLabel="emailAddress" label="" name='<%= "emailAddress" + i %>' size="65" title='<%= LanguageUtil.get(pageContext, "email-address") + StringPool.SPACE + (i + 1) %>' type="text" value="<%= emailAddress %>" />
