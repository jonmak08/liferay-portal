...
<div class="<%= cssClass %>">
	<input <%= autoFocus ? "autoFocus" : StringPool.BLANK %> class="search-query span9" id="<portlet:namespace /><%= id %>" name="<portlet:namespace /><%= name %>" placeholder="<%= placeholder %>" type="text" value="<%= HtmlUtil.escapeAttribute(value) %>" />
