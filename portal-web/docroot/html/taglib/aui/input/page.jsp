...
<c:choose>
	...
	<c:otherwise>
		...
		<c:if test="<%= autoFocus %>">
			<aui:script>
				Liferay.Util.focusFormField('#<%= HtmlUtil.escapeJS(namespace + id) %>');
			</aui:script>
		</c:if>
	</c:otherwise>
</c:choose>
