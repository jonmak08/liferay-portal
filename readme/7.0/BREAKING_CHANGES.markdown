...
### Removed the liferay-ui:input-move-boxes Tag and Replaced with liferay-frontend:input-move-boxes
- **Date:** 2016-Jan-22
- **JIRA Ticket:** LPS-62425

#### What changed?

The `liferay-ui:input-move-boxes` tag has been removed and replaced with the
`liferay-frontend:input-move-boxes` tag.

#### Who is affected?

Plugins and templates that are using the `liferay-ui:input-move-boxes` tag need to update
their usage of the tag.

#### How should I update my code?

You should import the `liferay-frontend` tag library (if necessary) and update
the tag namespace from `liferay-ui:input-move-boxes` to `liferay-frontend:input-move-boxes`.
